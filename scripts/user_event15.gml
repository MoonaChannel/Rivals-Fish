...
muno_char_name = "Sandbert";							// Here I replace the name, because "Sandbert with a Phone" is awkwardly long
...
with phone{
	...
	initTipImage_ext(player_id.spr_nspecial_proj, -5, fa_right, 1, c_white, 3, 40, 30, 60, 0);
	...
	initTipWords("Aside from adding the phone itself, this version of Sandbert changes a few small aspects about the code (mainly to serve those using this as a base for their own characters):");
...
with phone{
	...
	initPatch("1.1", "32 Mebruary, 2020");
	...
	initPatch("1.0", "30 Mebruary, 2020");
...
with phone{
	...
	initAbout("test", "you can have as many About things as u want btw");
